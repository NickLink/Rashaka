package rashakacom.rashaka.utils.helpers.views.phone;
 ...
 * </pre>
 */
public class PhoneEditText extends android.support.v7.widget.AppCompatEditText implements OnTouchListener, OnFocusChangeListener, PhoneWatcherAdapter.TextWatcherListener {
    ...
    private void init() {
        ...
        addTextChangedListener(new PhoneWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
