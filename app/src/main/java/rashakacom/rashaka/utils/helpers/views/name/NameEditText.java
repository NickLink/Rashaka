package rashakacom.rashaka.utils.helpers.views.name;
 ...
 * </pre>
 */
public class NameEditText extends android.support.v7.widget.AppCompatEditText implements OnTouchListener, OnFocusChangeListener, NameWatcherAdapter.TextWatcherListener {
    ...
    private void init() {
        ...
        addTextChangedListener(new NameWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
