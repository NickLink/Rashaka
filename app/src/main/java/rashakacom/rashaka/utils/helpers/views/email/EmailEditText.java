package rashakacom.rashaka.utils.helpers.views.email;
 ...
 * </pre>
 */
public class EmailEditText extends android.support.v7.widget.AppCompatEditText implements OnTouchListener, OnFocusChangeListener, EmailWatcherAdapter.TextWatcherListener {
    ...
    private void init() {
        ...
        addTextChangedListener(new EmailWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
