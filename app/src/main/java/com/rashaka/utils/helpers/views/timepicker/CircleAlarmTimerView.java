package com.rashaka.utils.helpers.views.timepicker;
...
public class CircleAlarmTimerView extends View {
    ...
    private static final float DEFAULT_TIMER_NUMBER_SIZE = 32;
    private static final float DEFAULT_TIMER_TEXT_SIZE = 16;
    ...
    private static final int DEFAULT_TIMER_NUMBER_COLOR = 0xFFFF00FF; //FFFFFFFF
