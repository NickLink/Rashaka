package com.rashaka.utils.helpers.views.passw;
 ...
 * </pre>
 */
public class PasswordEditText extends android.support.v7.widget.AppCompatEditText implements OnTouchListener, OnFocusChangeListener, PasswordWatcherAdapter.TextWatcherListener {
    ...
    private void init() {
        ...
        addTextChangedListener(new PasswordWatcherAdapter(this, this));
        initIcon();
        setClearIconVisible(false);
    }
